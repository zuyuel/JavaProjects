...
//        "<p>Quantity: " + resultData[0]["customerId"] + "</p>");
    ...
    // Find the empty table body by id "customer_table_body"
    let cartTableBodyElement = jQuery("#customer_table_body");
    ...
    for (let i = 0; i < resultData.length; i++) {
        ...
        rowHTML += "<th>" + resultData[i]["firstName"] + " " + resultData[i]["lastName"] + "</th>";
        rowHTML += "<th>" + resultData[i]["ccId"] + "</th>";
        rowHTML += "<th>" + resultData[i]["address"] + "</th>";
        rowHTML += "</tr>";
